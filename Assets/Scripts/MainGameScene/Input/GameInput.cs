...
public class GameInput : MonoBehaviour
{
    ...
    public event EventHandler<OnMouseValuesEventArgs> OnLeftClickAction;  // left  click
    ...
    private void Awake()
    {
        ...
        playerInputActions.Player.UseAtack.performed += UseAtack_performed;
    ...
    private void UseAtack_performed(UnityEngine.InputSystem.InputAction.CallbackContext obj)
    {
        OnLeftClickAction?.Invoke(this, new OnMouseValuesEventArgs
        {
            value = obj.ReadValue<float>()
        });
    }
